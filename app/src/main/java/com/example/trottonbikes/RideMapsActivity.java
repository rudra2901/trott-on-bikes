...
public class RideMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    Bike bike;
    LatLng userLocation;
    FusedLocationProviderClient mUserLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserLocation = LocationServices.getFusedLocationProviderClient(this);
    ...
    private void getLastLocation() {
        ...
        if (checkPermissions()) {
            ...
            if (isLocationEnabled()) {
                ...
                // FusedLocationClient
                // object
                mUserLocation.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
                    @Override
    ...
    private void requestNewLocationData() {
        ...
        mUserLocation = LocationServices.getFusedLocationProviderClient(this);
        mUserLocation.requestLocationUpdates(mLocationRequest, mLocationCallback, Looper.myLooper());
    }
